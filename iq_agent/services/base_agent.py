...
class BaseAgentUsingRosetta:
    def __init__(self, model_name):
        ...
        self.provider = rosetta.Provider(
        ...
        self.auditor = rosetta.auditor.Auditor(llm_name=model_name)
    ...
    def create_task_using_rosetta(self, control_flow_agent, prompt_name: str, **kwargs) -> controlflow.Task:
    ...
    def _get_handle_failed_task(self, control_flow_agent):
        return self.create_task_using_rosetta(control_flow_agent, prompt_name="handle_failed_task")
